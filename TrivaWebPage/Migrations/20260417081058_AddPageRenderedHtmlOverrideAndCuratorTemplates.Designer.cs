...
namespace TrivaWebPage.Migrations
{
    ...
    [Migration("20260417081058_AddPageRenderedHtmlOverrideAndCuratorTemplates")]
    partial class AddPageRenderedHtmlOverrideAndCuratorTemplates
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TrivaWebPage.Models.General.Page", b =>
                {
                    ...
                    b.Property<int?>("PageTemplatePageId")
                        .HasColumnType("int");

                    b.Property<string>("RenderedHtmlOverride")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("TrivaWebPage.Models.General.PageMediaFile", b =>
                {
                    ...
                    b.ToTable("PageMediaFiles", (string)null);
                });
            ...
            modelBuilder.Entity("TrivaWebPage.Models.General.Page", b =>
                {
                    b.HasOne("TrivaWebPage.Models.General.ColorPalette", "ColorPalette")
                        .WithMany("Pages")
                        .HasForeignKey("ColorPaletteId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.HasOne("TrivaWebPage.Models.General.PageTemplatePage", "PageTemplatePage")
                        .WithMany("Pages")
                        .HasForeignKey("PageTemplatePageId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.Navigation("ColorPalette");

                    b.Navigation("PageTemplatePage");
                });
            ...
            modelBuilder.Entity("TrivaWebPage.Models.General.PageTemplatePage", b =>
                {
                    b.HasOne("TrivaWebPage.Models.General.PageTemplate", "PageTemplate")
                        .WithMany("Pages")
